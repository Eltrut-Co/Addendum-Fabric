package com.github.EltrutCo.addendum.block;
...
public class OreoCoreStairsBlock extends Block implements Waterloggable {
    ...
    public OreoCoreStairsBlock(BlockState baseBlockState, AbstractBlock.Settings settings) {
        super(settings);
    ...
    public static boolean isStairs(BlockState state) {
        return state.getBlock() instanceof OreoCoreStairsBlock;
    }
